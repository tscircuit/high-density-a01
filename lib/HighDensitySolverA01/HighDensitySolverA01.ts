...
export interface HighDensitySolverA01Props {
  ...
  /**
   * Pairing preserves the original (f, insertion order) expansion sequence for
...
export class HighDensitySolverA01 extends BaseSolver {
  ...
  private heap!: MinHeap | PairingHeap
  ...
  override _setup(): void {
    ...
    this.nodePool = []
    this.heap =
      this.priorityQueue === "pairing" ? new PairingHeap() : new MinHeap()
    this.seqCounter = 0
  }
