...
export interface HighDensitySolverA02_V2Props {
...
export class HighDensitySolverA02_V2 extends BaseSolver {
  nodeWithPortPoints: NodeWithPortPoints
  outerGridCellSize: number
  outerGridCellThickness: number
  innerGridCellSize: number
  ...
  initialPenaltyFn?: HighDensitySolverA02_V2Props["initialPenaltyFn"]
  ...
  constructor(props: HighDensitySolverA02_V2Props) {
    super()
  ...
  override visualize() {
    ...
    return {
      ...
      title: `HighDensityA02_V2 [${this.getSolvedRouteCount()} solved, ${this.unsolvedSegs?.length ?? 0} remaining]`,
    }
  }
